            ...
            if not enemy:
                ...
                if ship.can_dock(targPlanet):
                    ...
                    navigate_command = ship.navigate(
                        ship.closest_point_to(targPlanet),
                        game_map,
                ...
                if ship.calculate_distance_between(ship.closest_point_to(targPlanet)) < hlt.constants.MAX_SPEED:
                    navigate_command = ship.navigate(planet, game_map, speed = hlt.constants.MAX_SPEED, ignore_ships=True,ignore_planets=True)
                    if navigate_command:
                        command_queue.append(navigate_command)
                else:
                    navigate_command = ship.navigate(ship.closest_point_to(targPlanet), game_map, speed = int(hlt.constants.MAX_SPEED*2/3), ignore_ships=True)
                    if navigate_command:
                        command_queue.append(navigate_command)
